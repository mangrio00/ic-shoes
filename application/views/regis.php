        ...
        <div class="row justify-content-center">
            <div class="col-12 col-sm-6 col-md-3">
              ...
              <div class="form-group">
                ...
                <input type="uname" class="form-control" id="exampleInputUname" aria-describedby="unameHelp" placeholder="Enter your Name">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="noHp" class="form-control" id="exampleInputnoHp" aria-describedby="noHpHelp" placeholder="Enter Phone Number">
              </div>
