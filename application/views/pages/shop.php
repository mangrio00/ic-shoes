            ...
            <div class="row">
                ...
                <div class="col-lg-12 order-1 order-lg-2 mb-5 mb-lg-0">
                    <header class="text-center mb-5">
                        <p class="small text-muted small text-uppercase mb-1">enjoy Shopping</p>
                        <h2 class="h5 text-uppercase mb-4">Browse our Special products</h2>
                    </header>
                        ...
                        <?php foreach ($barangs as $barang) : ?>
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <div class="product-overlay">
                                                <ul class="mb-0 list-inline">
                                                    <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark" href="#" action="<?= base_url('main/addToWishlist/' . $barang['id_barang']) ?>" method="POST"><i class="far fa-heart"></i></a></li>
                            ...
                            <?php else : ?>
                                <div class="col-lg-3 col-sm-6">
                                    <div class="product text-center">
                                        <div class="mb-3 position-relative">
                                            <div class="badge text-white badge-"></div><a class="d-block" href="#"><img style="height: 250px !important;" class="img-fluid w-100" src="<?= base_url('assets/img/barang/' . $barang['image']) ?>" alt="..."></a>
                                            <div class="product-overlay">
                                                <ul class="mb-0 list-inline">
